...
// console.log(`На вашем щету ${credits}`);

// const pricePerDroid = 3000;
// console.log(`Цена дроида ${pricePerDroid}`);
...
// console.log(`Доставка работает в страны ${countryChina}, ${countryChile}, ${countryAustralia}, ${countryIndia}, ${countryJamaica}.`);

// const moneyChina = '100 кредитов';
// const moneyChile = '250 кредитов';
// const moneyAustralia = '170 кредитов';
...
// // } else if(userInput === countryChile){
// //   alert('Стоемость доставки ' + moneyChile);  
// // } else if(userInput === countryAustralia){
// //   alert('Стоемость доставки ' + moneyAustralia);
// // } else if(userInput === countryIndia){
// //   alert('Стоемость доставки ' + moneyIndia);
// // } else if(userInput === countryJamaica){
// //   alert('Стоемость доставки ' + moneyJamaica);
// // } else if(userInput === null){
// //   alert('Отменено пользователем!');
// // }else {
// //   alert('В вашей стране доставка не доступна');
